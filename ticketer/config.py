...
TURNSTILE_SITEKEY = environ.get("TURNSTILE_SITEKEY", "1x00000000000000000000AA")
TURNSTILE_SECRET = environ.get("TURNSTILE_SECRET", "1x0000000000000000000000000000000AA")
